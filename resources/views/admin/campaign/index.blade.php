                        ...
                        @forelse($campaigns as $campaign)
                            <tr class="border bg-white">
                                ...
                                <td class="px-10 py-2 text-center">
                                    <a hx-boost="true" href="{{ route('admin.campaign.edit', $campaign->id) }}" class="bg-indigo-600 px-4 py-2 rounded shadow-sm text-xs text-white focus:outline-none">EDIT</a>
